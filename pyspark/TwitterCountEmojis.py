...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder\
        .appName("Find popular emojis in twitter")\
        .config("spark.mongodb.input.uri", "mongodb://127.0.0.1/twitter.tweets")\
        .config("spark.mongodb.output.uri", "mongodb://127.0.0.1/twitter.emojis")\
        .getOrCreate()
    ...
    emojis.write.format("com.mongodb.spark.sql").mode("overwrite").save()
